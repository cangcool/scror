  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved user_role as @user_role" do
        ...
        post :create, {:user_role => { "name" => "invalid value" }}, valid_session
        assigns(:user_role).should be_a_new(UserRole)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested user_role" do
        ...
        UserRole.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => user_role.to_param, :user_role => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the user_role as @user_role" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        UserRole.any_instance.stub(:save).and_return(false)
        put :update, {:id => user_role.to_param, :user_role => { "name" => "invalid value" }}, valid_session
        assigns(:user_role).should eq(user_role)
      end
