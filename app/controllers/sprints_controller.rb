class SprintsController < ApplicationController
  ...
  private
    ...
    def sprint_params
      params.require(:sprint).permit(:name, :description, :project_id, :sprint_order_number, :start_at, :end_at, :sprint_state_id, :creator_id, :modifier_id)
    end
end
